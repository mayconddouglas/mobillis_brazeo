...
export default function AppLayout() {
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-background text-foreground relative overflow-hidden shadow-2xl">
      <main className="flex-1 overflow-y-auto pb-20 scrollbar-hide">
        <Outlet />
      </main>

      <nav className="absolute bottom-0 w-full bg-card border-t border-border px-6 py-3 flex justify-between items-center rounded-t-2xl shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)] z-50">
